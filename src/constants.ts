...
export const ICONS = {
  ...
  Download: (props: React.SVGProps<SVGSVGElement>) => createSVG(
    React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M7.5 12l4.5 4.5m0 0l4.5-4.5M12 3v13.5" }), props
  ),
  Share2: (props: React.SVGProps<SVGSVGElement>) => createSVG(
    React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.18.324.283.696.283 1.093s-.103.77-.283 1.093m0-2.186l9.566-5.314m-9.566 7.5l9.566 5.314m0 0a2.25 2.25 0 103.935 2.186 2.25 2.25 0 00-3.935-2.186zm0-12.814a2.25 2.25 0 103.933-2.185 2.25 2.25 0 00-3.933 2.185z" }), props
  ),
  ...
  MessageSquare: (props: React.SVGProps<SVGSVGElement>) => createSVG(
  ...
  Mail: (props: React.SVGProps<SVGSVGElement>) => createSVG(
    React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" }), props
  ),
  Briefcase: (props: React.SVGProps<SVGSVGElement>) => createSVG(
  ...
  ShieldCheck: (props: React.SVGProps<SVGSVGElement>) => createSVG(
